    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(com.example.testtugas1.Register.this, login.class));
            }
        });
        ...
        BtnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!password.equals(conPassword)){
                    Toast.makeText(com.example.testtugas1.Register.this, "Password not match", Toast.LENGTH_SHORT).show();
                }else if (password.equals("") || username.equals("")){
                    Toast.makeText(com.example.testtugas1.Register.this, "Username or Password cannot be empty", Toast.LENGTH_SHORT).show();
                }else {
                    values.put(DBHelper.row_username, username);
                    values.put(DBHelper.row_password, password);
                    dbHelper.insertData(values);

                    Toast.makeText(com.example.testtugas1.Register.this, "Register successful", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
